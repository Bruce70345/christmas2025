...
export default function Explain() {
  const highlights = [
    "Christmas is always a lovely holiday, and I’m planning to send Christmas cards to friends in 2025.",
  ];

  return (
    <section className="banner-section min-h-[100vh] relative overflow-hidden p-[2rem] text-center lg:p-[4rem]]">
      <div className="space-y-5 w-[80vw] rounded-3xl border border-white/20 bg-white/5 text-left backdrop-blur p-[2rem] lg:p-[3rem] absolute top-[30%] left-1/2 -translate-x-1/2 lg:-translate-x-[-10%] lg:w-[40vw] lg:top-[55%]">
      ...
      <Image
        ...
        className="w-[100vw] absolute bottom-[5%] left-0 lg:left-[5%] lg:w-[50vw] z-20"
      />
      <h2
        className="absolute top-[5%] left-[0%] z-10 w-full text-center text-[18vw] uppercase md:text-[14vw] lg:w-[80%] lg:top-[5%] lg:left-[30%] lg:text-[9vw]"
